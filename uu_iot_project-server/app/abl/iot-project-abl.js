...
const Errors = require("../api/errors/iot-project-error.js");
...
const logger = LoggerFactory.get("IotProjectAbl");
...
module.exports = new IotProjectAbl();
